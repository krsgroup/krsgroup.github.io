...
const Overview = [
  ...
  'Schools, malls, shopping, hospitals in close vicinity',
  'Spread across area of 278 acres',
  'Plots available 60/100/150/200/250 Gaj'
]
...
const projects = {
  "virandavan": {
    title: 'KRS Shri RadhaRani Township Virandavan',
    Overview: Overview,
    Amenities: Amenities
  },
  "yamuna": {
    title: 'KRS Shri RadhaRani Township Yamuna Expressway',
    Overview: Overview,
    Amenities: Amenities
  },
  "kosi": {
    title: 'KRS Shri RadhaRani Township Kosi ',
    Overview: Overview,
    Amenities: Amenities
  },
  "barsana": {
    title: 'KRS Shri RadhaRani Township Barsana ',
    Overview: Overview,
    Amenities: Amenities
  },
}
    ...
    $('.portfolio-filter').each( function( i, buttonGroup ) {
        ...
        $buttonGroup.on( 'click', 'li', function() {
            ...
            $containerHeading.find('#heading').text(projects[textValue.toLowerCase()].title);
        });
    });

    var $container = $('.portfolio-wrapper');
    var $containerHeading = $('.portfolio-heading');
